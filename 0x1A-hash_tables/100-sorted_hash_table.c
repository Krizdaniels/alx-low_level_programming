...
/**
 * shash_table_create - To creates a hash table that can be sorted into
...
/**
 * dbl_ll_set - To sorts new node alphabetically into a doubly linked list
 * of hash table nodes
 * @ht: The sorted hash table to update with new node
 * @new: The newly allocated node
 */
...
/**
 * shash_table_get - To retrieves a value associated with a key in a sorted
 * hash table
...
/**
 * shash_table_print - To prints a sorted hash table from first to last in
 * sorted linked list
...
/**
 * shash_table_print_rev - To prints a sorted hash table from last to first
 ...
 * @ht: The sorted hash table to have memory freed
 */
